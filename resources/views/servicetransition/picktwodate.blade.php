...
<h6 style="color:red;">আপনি যে দুই তারিখসহ ও দুই তারিখের মধ্যবর্তী সকল ডেটের  সিট দেখতে চান তা নিচের  ফিল্ডে লিখুন। 
...
<form      method="post"  action="{{route('reporttransaction.dailyreport')}}"   >
 @csrf
