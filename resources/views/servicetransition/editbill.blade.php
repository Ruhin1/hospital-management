...
<div  class="container" style="background-color:#EEE8AA; "  >
  <span id="form_result"></span>
	...
	<div class="row">
    <div class="col-2">
      Name: <input type="text " value="{{$data->name}}"  readonly  class="form-control register_form nexttext" name="name" id="name"  placeholder="Enter Name" autocomplete="off" required>
    </div>
    <div class="col-2">
      Address: <input type="text " value="{{$data->address}}" readonly class="form-control register_form nexttext" name="address" id="address"  placeholder="Enter Address" autocomplete="off">
    </div>
	    <div class="col-2">
      Mobile: <input type="text " value="{{$data->mobile}}" readonly class="form-control register_form nexttext" name="mobile" id="mobile"  placeholder="Enter mobile" autocomplete="off">
    </div>
		    <div class="col-2">
      Age: <input type="text " value="{{$data->age}}" readonly class="form-control register_form nexttext" name="age" id="age"  placeholder="age" autocomplete="off">
    </div>
	
		    <div class="col-2">
      Sex: <input type="text " readonly   value="{{$data->sex}}" class="form-control register_form nexttext" name="sex" id="sex"  placeholder="Sex" autocomplete="off">
    </div>
...
<td>   <input type="text"  value= "{{ ($t->reportlist->unitprice )}}"  name="unit_price[]" id="unit_price" autocomplete="off" class="form-control numbers unit_price" required  />   </td>
