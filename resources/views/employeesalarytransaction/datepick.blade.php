...
<h6 style="color:red;">আপনি যে দুই তারিখসহ ও দুই তারিখের মধ্যবর্তী সকল ডেটের মোট স্যালারি সিট দেখতে চান তা নিচের ইনপুট ফিল্ডে লিখুন। 
...
<form      method="post"  action="{{route('employeetransactioncon.employeesalarymonth')}}"   >
 @csrf
