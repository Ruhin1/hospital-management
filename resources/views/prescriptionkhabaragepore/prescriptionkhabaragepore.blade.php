...
<div class="container">
  <div class="row">
    ...
    <h1>প্রিসক্রিপসন ব্যাবহার বিধি যেমন(  খাবার  আগে  বা পরে ) ইত্যাদি লিখেন </h1>
        ...
        <div class="modal-body">
         ...
         <form method="post" id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label class="control-label col-md-4" > USAGES : </label>
            <div class="col-md-8">
...
$(document).ready(function(){
    ...
    var table = $('#patient_table').DataTable({
        ...
        ajax: "{{ route('prescriptionusagestwo.index') }}",
        columns: [
		
		 {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'id', name: 'id'},
            {data: 'khabaragebapore', name: 'khabaragebapore'},
...
$('#sample_form').on('submit', function(event){
  ...
  {
   $.ajax({
    url:"{{ route('prescriptionusagestwo.store') }}",
    method:"POST",
  ...
  {
   $.ajax({
    url:"{{ route('prescriptionusagestwo.update') }}",
    method:"POST",
    data:new FormData(this),
    contentType: false,
    cache: false,
 ...
 $(document).on('click', '.edit', function(){
  ...
  $('#form_result').html('');
  $.ajax({
   url:"/prescriptionusagestwo/"+id+"/edit",
   dataType:"json",
   success:function(html){
    $('#name').val(html.data.khabaragebapore);
 ...
 $('#ok_button').click(function(){
  $.ajax({
   url:"prescriptionusagestwo/destroy/"+user_id,
   beforeSend:function(){
