...
<h6 style="color:red;"> যে দুই তারিখসহ ও দুই তারিখের মধ্যবর্তী সকল ডেটের -  যে কোন একটি নির্দিষ্ট এজেন্ট এর ট্রাঞ্জিশন দেখতে চান  তা নিচের  ফিল্ডে লিখুন। 
...
<form      method="post"  action="{{route('agenttransaction.agentfetch')}}"   >
 @csrf
