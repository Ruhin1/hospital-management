...
<div class="row">
	    ...
	    <div class="col-3">
Quantity : 	<input type="text"  autocomplete="off"  name="unit" id="unit" class="form-control  unit" required  />
    </div>
	    ...
	    <div class="col-3">
  <input type="radio" id="buying" name="type" value="0">
  <label for="html">Buying</label><br>
  <input type="radio" id="consuming" name="type" value="1">
  <label for="css">Consuming</label><br>
</div>
...
////////////////////////////////////////////////////// 
    ...
    var table = $('#patient_table').DataTable({
        ...
        ajax: "{{ route('khorochtransition.sompod') }}",
...
$('#sample_form').on('submit', function(event){
  ...
  if($('#action').val() == 'Add')
  {
   ...
   $.ajax({
    url:"{{ route('khorochtransition.store_sompod') }}",
    method:"POST",
