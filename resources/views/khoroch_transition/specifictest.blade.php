...
<h6 style="color:red;">আপনি যে দুই তারিখসহ ও দুই তারিখের মধ্যবর্তী সকল ডেটের -  যে কোন একটি নির্দিষ্ট খরচের সিট দেখতে চান তা নিচের  ফিল্ডে লিখুন। 
...
<form      method="post"  action="{{route('khorochtransition.listfetch')}}"   >
 @csrf
...
খরচের নামঃ
<select  style="width:300px;" name="khorocer_khad" id="khorocer_khad" required>
  <option value=""></option>
@foreach ( $khorocer_khad as $p  )
