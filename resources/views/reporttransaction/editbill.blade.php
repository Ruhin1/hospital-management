...
<label for="agentcom"> NO  </label>
  ...
  <div class="row">
      ...
      <div class="col-4 ">
      Delivery Date:<input type="datetime-local" id="deliverydate"  value="{{$data->deliverydate}}" name="deliverydate" >
    </div>

    <div class= " col-4">
     Data Entry Date:<input  type="datetime-local" id="dataentry" value="{{$data->created_at}}" name="dataentry" >
