...
<div  class="container" style="background-color:#EEE8AA; "  >
  ...
  <h2  style="color:rgb(241, 75, 75)"> Pathology Billing Section </h2>
  ...
  <div class="row">
    <div class="col-4">
       ...
       Patient list : <select id="customer_id"  class="form-control customer_id"  name="customer_id"    >  
      </select>
      </div>
	...
	Admitted Patient : <select id="all_patient"  class="form-control all_patient"  name="all_admitted_patient"    >  
	  </select>
    </div>
...
<label for="showadmitform">  New   </label>
  ...
  <p>
    <div class="row">
	    ...
	    <div class="col-4">
<span style="color:red;"> Reference:-  </span><input type="radio" id="doctorcom"  name="commissiontype" value="1" required >
...
<label for="agentcom"> NO  </label>
  ...
  <div class="row">
    ...
    <div class="col-4 ">
      Delivery Date:<input type="datetime-local" id="deliverydate" name="deliverydate" required>
    </div>
...
$('#dataentry').val(new Date().toDateInputValue());
    ...
    var table = $('#patient_table').DataTable({
        ...
        columns: [
		 ...
		 {data: 'DT_RowIndex', name: 'DT_RowIndex'},	
			...
			{data: 'id', name: 'id'},
			 {data: 'patient_id', name: 'patient.id'},
...
var option = "<option value=''></option>";                   
  ...
  var status = response.patientdata[i].booking_status;
						   ...
						   + " ID:" + id + " Bed:"  +cabine+ "( "+ name+ "-" +mobile+      ")"+   						   
						   "</option>"; 


							  $("#customer_id").append(option);

 if (response.patientdata[i].booking_status == 1) {
                $("#all_patient").append(option);
 }
...
// $('.form-horizontal').delegate('.customer_id, .all_patient', 'change', function(){
...
$('.form-horizontal').delegate('.all_patient','change',function(){
 
 var name = $('.all_patient option:selected').attr("data-name");        
 var age = $('.all_patient option:selected').attr("data-age");
 var sex = $('.all_patient option:selected').attr("data-sex");
 var address = $('.all_patient option:selected').attr("data-address");
 var mobile = $('.all_patient option:selected').attr("data-mobile");
 var deposit = $('.all_patient option:selected').attr("data-deposit");
 console.log(deposit);
 $('#name').val(name);
 $('#age').val(age);
 $('#sex').val(sex);
...
// giving commission by percentage
