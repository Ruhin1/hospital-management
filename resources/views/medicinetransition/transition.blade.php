...
<body id="bodysellcorner">
    ...
    @endif
      ...
      <h2  style="color:rgb(241, 75, 75)"> Medicine Sales</h2>
		...
		<form method="post" action="{{ route('medicinetransition.index') }}"   id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          @csrf
		   ...
		   <div class="col-4">Cabine NO :  
	        ...
	        <select id="regcustomer"  class="form-control "  name="regcustomer" >  
...
<label for="showadmitform"> Register A New Customer   </label>
                ...
                success: function(response) {
                    ...
                    if (len > 0) {
                        for (var i = 0; i < len; i++) {
                            ...
                            var optionforid = "<option    data-val='" + id + "'   data-status='" + status + "'   value='" + id + "'>" +
                    ...
                    if (len > 0) {
                        for (var i = 0; i < len; i++) {
                            ...
                            var optionforid = "<option    data-val='" + id + "'   data-status='" + status + "'   value='" + id + "'>" + name + " (" + mobile + ")" + "</option>";
