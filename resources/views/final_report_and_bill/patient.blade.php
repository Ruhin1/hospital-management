...
  <label for="dena"> এডজাস্ট করুন ( প্রকৃত পক্ষে কোন লেনদেন হয় না )  </label><br>	   
		  ...
		  Refund: <input type="text"   autocomplete="off" value="0" name="Pahermachy_refund" id="Pahermachy_refund" class="form-control" />
		   ...
		   Due Payment: <input type="text"  autocomplete="off" value="0" name="admission_due_payment" id="admission_due_payment" class="form-control" />
		   ...
		   Concession: <input type="text"  autocomplete="off" value="0" name="admission_due_dis" id="admission_due_dis" class="form-control" />
		  ...
		  Refund: <input type="text"   autocomplete="off" value="0" name="admission_fee_refund" id="admission_fee_refund" class="form-control" />
...
<P>
       ...
       <select id="doctor"  class="form-control doctor"  name="doctorid"     style='width: 270px;'>  
		...
		Admission Fees's  Comment : <input type="text"  name="admission_due_comment" id="admission_due_comment" class="form-control" />
...
$('#calcul').delegate('#pathologydue_due_payment, #Pahermachy_due_payment, #admission_due_payment, #service_due_payment, #surgery_due_payment, #doctor_due_payment','change',function(){
	...
	var total =  service + pathologydue_due_payment + Pahermachy_due_payment + surgery_due_payment + doctor_due_payment + admission_fee_due_payment;
	$('#amount').val(total);
