...
<b> Total Due </b> = Initial Due - Total Deposit.<br>
 Initial Due =<?php  echo round(($data->due + $cabinedue), 0);  ?>  TK , Total Deposit = <?php  echo round(($data->dena), 0);  ?> TK <br>
 So Total Due =<?php  echo round(($data->due + $cabinedue), 0);  ?>  - <?php  echo round(($data->dena), 0);  ?>= <?php  echo round(($data->due + $cabinedue-$data->dena), 0);  ?> TK

<?php $totaldiscount = $total_surger_discount + $service_discount+ $total_cabine_admission_discount + $rdiscount + $doctorvisitduediscount + $cabinediscount + $mdiscount - $reurtn_medicine_discount;
...
@csrf 
		 ...
		 <input type="hidden" name="cabinedue" value=" {{$cabinedue}}" id="cabinedue" autocomplete="off" class="form-control  "  />	 
...
<div id="additionalservice" >
       ...
       <select id="service_name"  class="form-control service_name" style='width: 270px;'  name="service_name[]"     >  
			 ...
			 <input type="hidden" name="flag" value=" {{$flag}}" id="flag" autocomplete="off" class="form-control  "  />	 	
				 ...
				 <input type="hidden" name="finaldiscount" value=" {{$totaldiscount}}" id="discount" autocomplete="off" class="form-control  "  />	 	
  ...
  <b style="color:white" >  Service Charges Paid : </b>
  
   <div class="row"   style="background-color:#2F4F4F"       >

	    <div class="col-4">
 <b style="color:white;">  Paid: </b> <input type="text" name="servpaid" id="servpaid"  value="0"  class="form-control numbers servpaid"  />
    </div>


	    <div class="col-4">
 <b style="color:white;">  Adjust: </b> <input type="text" name="serviceadjust" id="serviceadjust"  value="0"  class="form-control numbers serviceadjust"  />
    </div>
