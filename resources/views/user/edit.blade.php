                ...
                <div class="card">
                    <div class="card-header p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ Route('user.index') }}" class="btn btn-primary btn-sm text-uppercase">Go Back</a>
                        </div>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label for="Email" class="form-label require"><b>Email</b></label>
                                <input type="text" class="form-control custom-input" id="user_name" name="email" placeholder="User ID" required value="{{ $user->email }}">
                            </div>
                            <div class="col-12">
