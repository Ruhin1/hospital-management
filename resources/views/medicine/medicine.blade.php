 ...
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
	...
	<select id="category"  class="form-control "  name="category"  required   style='width: 270px;'>
            ...
            <div class="form-group ">
                ...
                <input type="email " class="form-control register_form " name="unitprice" id="unitprice" placeholder="Unit Price"  autocomplete="off" >
            </div>
