           ...
           <div id="address_div" class="form-group">
            ...
            <div class="col-md-8">
             <input type="text" autocomplete="off" name="mobile" id="mobile" class="form-control" />
		             ...
		             <div id="mobile_div" class="form-group">
            <label class="control-label col-md-4">Present Due Amount : </label>
            <div class="col-md-8">
             <input type="text" autocomplete="off" name="dueamount" id="dueamount" class="form-control" />
            </div>
           </div>
  ...
  if($('#action').val() == 'Add')
  {
   $.ajax({
    ...
    success:function(data)
    {
     ...
     $('#form_result').html(html).delay(5000).fadeOut();;
    }
   })
  }
