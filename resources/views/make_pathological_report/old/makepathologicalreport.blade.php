...
<div class="container">
  <div class="row">
    <div class="col-sm">
    Ref.Doctor       
<input type="text"   name="doctorname" id="doctorname" class="form-control  doctorname" required readonly />	
	 ...
	 $("#doctor").html("");  
                    ...
                    if (len>0) {
                        for (var i = 0; i<len; i++) {
                             ...
                             var test_name = "<option     data-name='"+name+"'   value='"+id+"'>"+name+"</option>"; 
                    ...
                    if (len>0) {
                        for (var i = 0; i<len; i++) {
							...
							var pid = response.reportorder[i].patient.id;
							  	...
							  	if (response.referdoctor == null )
								{
									doctor_name= 'Not applicable';
								}
								else{ 
									 var doctor_name = response.referdoctor.name;
								}
							 var doctor_id = response.reportorder[i].doctor_id; 
                             var optionfororder = "<option  data-doctor_name='"+doctor_name+"' data_doctor_id='"+doctor_id+"'   data-id='"+pid+"'  data-name='"+name+"'   value='"+id+"'>"+id+"</option>"; 
