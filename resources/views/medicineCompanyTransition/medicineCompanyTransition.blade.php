...
<body id="bodysellcorner">
    ...
    @endif
		...
		<h2> Buy/ Buy Return Medicine </h2>
  <span id="form_result"></span>
	
		<form method="post" action="{{ route('medicinecomapnytransition.store') }}"   id="sample_form" class="form-horizontal" enctype="multipart/form-data">
          @csrf
...
Date:  <input type="date"  required id="datePicker" name="date" class="form-control" />
  ...
  <p>	 
       ...
       <select id="medicine_name"  class="form-control medicine_name"  name="medicine_name[]"  required   style='width: 200px;'>  
                        ...
                        <td>
						  <input type="text" autocomplete="off"  name="unit_price[]" id="unit_price" class="form-control numbers  unit_price" required style='width: 100px;' />
                           
                        </td>
						<td>
						  <input type="text" autocomplete="off" name="quantity[]" id="quantity" class="form-control numbers quantity" required />
						</td>
 ...
 Gross Amount :  <input type="text" name="grossamount" id="grossamount"  value="0"  class="form-control  grossamount" readonly />
	...
	Payable Amount	   <input type="text" autocomplete="off" name="totalamount" id="totalamount"  value="0"  class="form-control numbers totalamount"  />
