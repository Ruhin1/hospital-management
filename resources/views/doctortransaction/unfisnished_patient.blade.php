...
<div class="container"          style="background-color:#EEE8AA; "  >
		...
		<form method="post"   action="{{ route('dentalservice.fetchpatorder') }}"   id="sample_form" class="form-horizontal  sample_form_for_doctorappointment" enctype="multipart/form-data">
          @csrf
		    ...
		    <div class="row">
    <div class="col-4">
  Select Patient:    <select id="patientlist"  class="form-control patientlist"  name="patientlist"     style='width: 270px;'>
    </select>
    </div>
...
success:function (response) {
	...
	var option = "<option  value='' ></option>"; 
                    ...
                    if (len>0) {
					 ...
					 var long_term_installment = response.patientdata[i].long_term_installment;
                             var option = "<option  data-id='"+id+"'   data-deposit='"+deposit+"' data-long_term_installment='"+long_term_installment+"'      data-due='"+due+"'   data-name='"+name+"' data-address='"+address+"'  data-age='"+age+"' data-sex='"+sex+"' data-mobile='"+mobile+"' value='"+id+"'>"+name+ "( "+ mobile+ ")"+   "</option>"; 
 ...
 function fetc_longterm_install( id ){
  $.ajax({
   url:"dentalserviceinstallment/"+id,
   dataType:"json",
